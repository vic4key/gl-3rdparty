...
// Ticket #123
	...
	{
		return detail::format("float(%.2f)", x);
	}

	GLM_FUNC_QUALIFIER std::string to_string(double x)
	{
		return detail::format("double(%.2f)", x);
	}
	...
	{
		return detail::format("fvec2(%.2f, %.2f)", v.x, v.y);
	}
	...
	{
		return detail::format("fvec3(%.2f, %.2f, %.2f)", v.x, v.y, v.z);
	}
	...
	{
		return detail::format("fvec4(%.2f, %.2f, %.2f, %.2f)", v.x, v.y, v.z, v.w);
	}
	...
	{
		return detail::format("dvec2(%.2f, %.2f)", v.x, v.y);
	}
	...
	{
		return detail::format("dvec3(%.2f, %.2f, %.2f)", v.x, v.y, v.z);
	}
	...
	{
		return detail::format("dvec4(%.2f, %.2f, %.2f, %.2f)", v.x, v.y, v.z, v.w);
	}
	...
	{
		return detail::format("hmat2x2((%.2f, %.2f), (%.2f, %.2f))", 
	...
	{
		return detail::format("hmat2x3((%.2f, %.2f, %.2f), (%.2f, %.2f, %.2f))", 
	...
	{
		return detail::format("hmat2x4((%.2f, %.2f, %.2f, %.2f), (%.2f, %.2f, %.2f, %.2f))", 
	...
	{
		return detail::format("hmat3x2((%.2f, %.2f), (%.2f, %.2f), (%.2f, %.2f))", 
	...
	{
		return detail::format("hmat3x3((%.2f, %.2f, %.2f), (%.2f, %.2f, %.2f), (%.2f, %.2f, %.2f))", 
			x[0][0].toFloat(), x[0][1].toFloat(), x[0][2].toFloat(), 
			x[1][0].toFloat(), x[1][1].toFloat(), x[1][2].toFloat(),
	...
	{
		return detail::format("hmat3x4((%.2f, %.2f, %.2f, %.2f), (%.2f, %.2f, %.2f, %.2f), (%.2f, %.2f, %.2f, %.2f))", 
			x[0][0].toFloat(), x[0][1].toFloat(), x[0][2].toFloat(), x[0][3].toFloat(), 
			x[1][0].toFloat(), x[1][1].toFloat(), x[1][2].toFloat(), x[1][3].toFloat(), 
	...
	{
		return detail::format("hmat4x2((%.2f, %.2f), (%.2f, %.2f), (%.2f, %.2f), (%.2f, %.2f))", 
			x[0][0].toFloat(), x[0][1].toFloat(), 
			x[1][0].toFloat(), x[1][1].toFloat(), 
			x[2][0].toFloat(), x[2][1].toFloat(), 
	...
	{
		return detail::format("hmat4x3((%.2f, %.2f, %.2f), (%.2f, %.2f, %.2f), (%.2f, %.2f, %.2f), (%.2f, %.2f, %.2f))", 
			x[0][0].toFloat(), x[0][1].toFloat(), x[0][2].toFloat(),
			x[1][0].toFloat(), x[1][1].toFloat(), x[1][2].toFloat(), 
			x[2][0].toFloat(), x[2][1].toFloat(), x[2][2].toFloat(),
	...
	{
		return detail::format("hmat4x4((%.2f, %.2f, %.2f, %.2f), (%.2f, %.2f, %.2f, %.2f), (%.2f, %.2f, %.2f, %.2f), (%.2f, %.2f, %.2f, %.2f))", 
			x[0][0].toFloat(), x[0][1].toFloat(), x[0][2].toFloat(), x[0][3].toFloat(),
			x[1][0].toFloat(), x[1][1].toFloat(), x[1][2].toFloat(), x[1][3].toFloat(),
			x[2][0].toFloat(), x[2][1].toFloat(), x[2][2].toFloat(), x[2][3].toFloat(),
	...
	{
		return detail::format("mat2x3((%.2f, %.2f, %.2f), (%.2f, %.2f, %.2f))", 
			x[0][0], x[0][1], x[0][2], 
			x[1][0], x[1][1], x[1][2]);
	}
	...
	{
		return detail::format("mat2x4((%.2f, %.2f, %.2f, %.2f), (%.2f, %.2f, %.2f, %.2f))", 
	...
	{
		return detail::format("mat3x2((%.2f, %.2f), (%.2f, %.2f), (%.2f, %.2f))", 
			x[0][0], x[0][1], 
			x[1][0], x[1][1], 
			x[2][0], x[2][1]);
	}
	...
	{
		return detail::format("mat3x4((%.2f, %.2f, %.2f, %.2f), (%.2f, %.2f, %.2f, %.2f), (%.2f, %.2f, %.2f, %.2f))", 
			x[0][0], x[0][1], x[0][2], x[0][3], 
			x[1][0], x[1][1], x[1][2], x[1][3], 
	...
	{
		return detail::format("mat4x2((%.2f, %.2f), (%.2f, %.2f), (%.2f, %.2f), (%.2f, %.2f))", 
			x[0][0], x[0][1], 
			x[1][0], x[1][1], 
			x[2][0], x[2][1], 
			x[3][0], x[3][1]);
	...
	{
		return detail::format("mat4x3((%.2f, %.2f, %.2f), (%.2f, %.2f, %.2f), (%.2f, %.2f, %.2f), (%.2f, %.2f, %.2f))", 
			x[0][0], x[0][1], x[0][2],
			x[1][0], x[1][1], x[1][2], 
			x[2][0], x[2][1], x[2][2],
			x[3][0], x[3][1], x[3][2]);
	...
	{
		return detail::format("dmat2x2((%.2f, %.2f), (%.2f, %.2f))", 
			x[0][0], x[0][1], 
			x[1][0], x[1][1]);
	}
	...
	{
		return detail::format("dmat2x3((%.2f, %.2f, %.2f), (%.2f, %.2f, %.2f))", 
			x[0][0], x[0][1], x[0][2], 
			x[1][0], x[1][1], x[1][2]);
	}
	...
	{
		return detail::format("dmat2x4((%.2f, %.2f, %.2f, %.2f), (%.2f, %.2f, %.2f, %.2f))", 
			x[0][0], x[0][1], x[0][2], x[0][3], 
			x[1][0], x[1][1], x[1][2], x[1][3]);
	}
	...
	{
		return detail::format("dmat3x2((%.2f, %.2f), (%.2f, %.2f), (%.2f, %.2f))", 
			x[0][0], x[0][1], 
			x[1][0], x[1][1],
			x[2][0], x[2][1]);
	}
	...
	{
		return detail::format("dmat3x3((%.2f, %.2f, %.2f), (%.2f, %.2f, %.2f), (%.2f, %.2f, %.2f))", 
			x[0][0], x[0][1], x[0][2], 
			x[1][0], x[1][1], x[1][2],
			x[2][0], x[2][1], x[2][2]);
	}
	...
	{
		return detail::format("dmat3x4((%.2f, %.2f, %.2f, %.2f), (%.2f, %.2f, %.2f, %.2f), (%.2f, %.2f, %.2f, %.2f))", 
			x[0][0], x[0][1], x[0][2], x[0][3], 
			x[1][0], x[1][1], x[1][2], x[1][3],
			x[2][0], x[2][1], x[2][2], x[2][3]);
	}
	...
	{
		return detail::format("dmat4x2((%.2f, %.2f), (%.2f, %.2f), (%.2f, %.2f), (%.2f, %.2f))", 
			x[0][0], x[0][1], 
			x[1][0], x[1][1], 
			x[2][0], x[2][1], 
			x[3][0], x[3][1]);
	...
	{
		return detail::format("dmat4x3((%.2f, %.2f, %.2f), (%.2f, %.2f, %.2f), (%.2f, %.2f, %.2f), (%.2f, %.2f, %.2f))", 
			x[0][0], x[0][1], x[0][2], 
			x[1][0], x[1][1], x[1][2], 
			x[2][0], x[2][1], x[2][2], 
			x[3][0], x[3][1], x[3][2]);
	...
	{
		return detail::format("dmat4x4((%.2f, %.2f, %.2f, %.2f), (%.2f, %.2f, %.2f, %.2f), (%.2f, %.2f, %.2f, %.2f), (%.2f, %.2f, %.2f, %.2f))", 
			x[0][0], x[0][1], x[0][2], x[0][3],
			x[1][0], x[1][1], x[1][2], x[1][3],
			x[2][0], x[2][1], x[2][2], x[2][3],
			x[3][0], x[3][1], x[3][2], x[3][3]);
